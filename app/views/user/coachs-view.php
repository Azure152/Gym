...
<html lang="es">
	<head>
		...
		<title>Entrenadores | Make Your Body</title>
	...
	<body id="body">
		<main id="main">
			...
			<div class="page-content page-products page-products-admin page-coachs">
				<!-- filter-bar -->
				<div class="filter-bar-container">
					...
					<div class="forms-products-admin">
						<button type="button" class="btn btn-safe btn-apply-coachs">Solicitar ser entrenador</button>
					</div>
				</div>
				<!-- coachs -->
				<button class="coachs-container" productId="1">
				...
				?>
					<button class="coachs-container" productId="<?php echo encryption( $product['id']) ?>">
						<img src="<?php echo SERVER_URL ?>/public/img/users/<?php echo $product['img'] ?>" alt="">
